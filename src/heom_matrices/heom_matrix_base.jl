...
HEOMSparseStructure(bath::bosonInputFunction, Nado::Int) = HEOMSparseStructure(Comm = COOFormat(Nado))
HEOMSparseStructure(bath::bosonOutputFunctionLeft, Nado::Int) = HEOMSparseStructure(spre = COOFormat(Nado))
HEOMSparseStructure(bath::bosonOutputFunctionRight, Nado::Int) = HEOMSparseStructure(spost = COOFormat(Nado))
HEOMSparseStructure(bath::bosonOutputLeft, Nado::Int) = HEOMSparseStructure(spre = COOFormat(Nado))
HEOMSparseStructure(bath::bosonOutputRight, Nado::Int) = HEOMSparseStructure(spost = COOFormat(Nado))
